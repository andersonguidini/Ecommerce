...
namespace Repository
{
    public class ItemVendaDAO:IRepository<ItemVenda>
    {
        ...
        public List<ItemVenda> ListarPorCarrinhoId(string carrinhoId)
        {
            return _context.ItensVenda.Include(x => x.Produto.Categoria).Where(x => x.CarrinhoId.Equals(carrinhoId)).ToList();
        }
    }
}
